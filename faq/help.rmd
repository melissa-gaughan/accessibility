...
-   **Sum Asset Category Baseline:** The number of distinct types of community assets that can be reached from each origin point using the baseline transit network.

-   **Sum Asset Category Proposed:**The number of distinct types of community assets that can be reached from each origin point using the proposed transit network.

-   **Change in Coverage Category:** The change in the number of distinct types of community assets that can be reached from each origin point between the proposed and baseline transit networks.
